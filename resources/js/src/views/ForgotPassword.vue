        ...
        >
          <validation-observer ref="loginValidation">
            <b-form
              ...
              @submit.prevent
            >
              <b-card-title>Wprowadź adres email, aby otrzymać na niego link do przypomnienia hasła </b-card-title>
              <b-form-group
...
import {
  BButton, BFormInput, BRow, BCol, BCardText, BCardTitle, BFormGroup, BForm, BImg, BLink,
} from 'bootstrap-vue'
  ...
  computed: {
    imgUrl() {
      if (store.state.appConfig.layout.skin === 'dark') {
        ...
        this.sideImg = require('@/assets/images/pages/reset-password-v2.svg')
        return this.sideImg
      }
    },
  },
